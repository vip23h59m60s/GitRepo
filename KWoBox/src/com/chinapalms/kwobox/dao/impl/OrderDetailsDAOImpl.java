...
import com.chinapalms.kwobox.dao.OrderDetailsDAO;
...
public class OrderDetailsDAOImpl implements OrderDetailsDAO {
    ...
    public boolean addOrderDetails(OrderDetails orderDetails) {
        ...
        String sql = "INSERT INTO t_order_details(orderId, barCodeId, goodsName, salesMode, goodsPrice, goodsFavorablePrice, goodsActualPrice, categoryGoodsNumber, categoryGoodsWeight, categoryGoodsPrice, categoryfavorablePrice, actualCategoryPrice) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    public List<OrderDetails> findOrderDetailsByOrderId(String orderId) {
        Connection connection = JDBCUtil.getDBConnection();
        String sql = "SELECT * FROM t_order_details WHERE orderId = ?";
        PreparedStatement ps = null;
        ResultSet rs = null;

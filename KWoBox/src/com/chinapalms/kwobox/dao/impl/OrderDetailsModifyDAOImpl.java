...
public class OrderDetailsModifyDAOImpl implements OrderDetailsModifyDAO {

    Log log = LogFactory.getLog(OrderModifyDAOImpl.class);

    @Override
    public boolean addOrderDetailsModify(OrderDetailsModify orderDetails) {
        boolean addFlag = false;
        Connection connection = JDBCUtil.getDBConnection();
        String sql = "INSERT INTO t_order_details_modify(orderId, barCodeId, goodsName, salesMode, goodsPrice, goodsFavorablePrice, goodsActualPrice, categoryGoodsNumber, categoryGoodsWeight, categoryGoodsPrice, categoryfavorablePrice, actualCategoryPrice) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";

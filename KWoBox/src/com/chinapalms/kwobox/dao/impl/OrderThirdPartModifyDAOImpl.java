...
import com.chinapalms.kwobox.dao.OrderThirdPartModifyDAO;
...
public class OrderThirdPartModifyDAOImpl implements OrderThirdPartModifyDAO {

    Log log = LogFactory.getLog(OrderThirdPartModifyDAOImpl.class);

    @Override
    public boolean addOrderThirdPartModify(OrderThirdPartModify order) {
        boolean addFlag = false;
        Connection connection = JDBCUtil.getDBConnection();
        String sql = "INSERT INTO t_orders_thirdpart_modify(orderId, newOrderId, phoneNumber, vipLevel, boxId, goodsTotalNumber, payTotal, totalFavourable, actualPayTotal, payType, thirdPayOrderId, outTradeNo, transactionId, payState, payDate, buyDate, orderUpdateOwner, orderUpdateDate) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";

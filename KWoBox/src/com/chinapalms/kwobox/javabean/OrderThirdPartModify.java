...
public class OrderThirdPartModify {
    ...
    public String toString() {
        return "OrderThirdPartModify [orderId=" + orderId + ", newOrderId="
                + newOrderId + ", phoneNumber=" + phoneNumber + ", vipLevel="
                + vipLevel + ", boxId=" + boxId + ", goodsTotalNumber="
                + goodsTotalNumber + ", payTotal=" + payTotal
                + ", totalFavourable=" + totalFavourable + ", actualPayTotal="
                + actualPayTotal + ", payType=" + payType
                + ", thirdPayOrderId=" + thirdPayOrderId + ", outTradeNo="
                + outTradeNo + ", transactionId=" + transactionId
                + ", payState=" + payState + ", payDate=" + payDate
                + ", buyDate=" + buyDate + ", orderUpdateOwner="
                + orderUpdateOwner + ", orderUpdateDate=" + orderUpdateDate
                + "]";
    }

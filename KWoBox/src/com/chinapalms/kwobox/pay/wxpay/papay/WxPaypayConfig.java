...
public class WxPaypayConfig {
    ...
    private static String plan_id = "121466";
    ...
    //退款原因說明
    private static String refund_desc = "商品退款";

    public static String getRefund_desc() {
        return refund_desc;
    }

    public static void setRefund_desc(String refund_desc) {
        WxPaypayConfig.refund_desc = refund_desc;
    }
    ...
    public static void setPlan_id(String plan_id) {
        WxPaypayConfig.plan_id = plan_id;
    }
    ...
    public static void setContract_display_account(
        ...
        WxPaypayConfig.contract_display_account = contract_display_account;
    }
    ...
    public static void setEntrust_notify_url(String entrust_notify_url) {
        WxPaypayConfig.entrust_notify_url = entrust_notify_url;
    }
    ...
    public static void setPay_success_notify_url(String pay_success_notify_url) {
        WxPaypayConfig.pay_success_notify_url = pay_success_notify_url;
    }
    ...
    public static void setTemplateMsgId(String templateMsgId) {
        WxPaypayConfig.templateMsgId = templateMsgId;
    }
    ...
    public static void setMiniProgramPage(String miniProgramPage) {
        WxPaypayConfig.miniProgramPage = miniProgramPage;
    }

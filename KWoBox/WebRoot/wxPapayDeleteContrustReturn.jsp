...
<%@page import="com.chinapalms.kwobox.utils.ResponseStatus"%>
<%@page import="com.chinapalms.kwobox.service.UserService"%>
...
<body>
    <%
        ...
        try {
            ...
            log.info("wxPapayDeleteEntrustReturn.jsp sb.xml="
                    + sb.toString());
            //Xml解析防止XXE实体注入策略合入
            ...
            if (changeType != null && changeType.getText().equals("DELETE")
                    && resultCode != null
            ...
            if (contractId != null && contractId.getText().length() > 0) {
                UserService userService = new UserService();
                userService.clearContractId(contractId.getText(),
